...
set_pixel:
        push ebx
        imul ebx, ebx, Dword 1920
        add eax, ebx
        mov [eax*4+display_start], ecx
        pop ebx
        ret
...
;set pixel with parameters from stdin
 ...
 imul ebx, ebx, 1920 ; pro reihe +1920 pixel
 add eax, ebx ; + x koordinate (pixel)
 imul eax, eax, 4 ; * 4 da pixel aus 4 byte
